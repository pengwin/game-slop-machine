...
pub(super) fn write_rgba(data: &mut [u8], size: TextureSize, x: u32, y: u32, rgba: [f32; 4]) {
...
pub(super) fn wrapped_delta(delta: f32) -> f32 {
    if delta > 0.5 {
        delta - 1.0
    } else if delta < -0.5 {
        delta + 1.0
...
pub(super) fn distance_to_segment(p: [f32; 2], a: [f32; 2], b: [f32; 2]) -> f32 {
