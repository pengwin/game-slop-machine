...
impl MaterialSliderSetting {
    const fn value(&self, settings: &PlasterWallMaterialSettings) -> f32 {
        match self {
    ...
    fn set(&self, settings: &mut PlasterWallMaterialSettings, value: f32) {
        match self {
...
impl MaterialCheckboxSetting {
    const fn value(&self, settings: &PlasterWallMaterialSettings) -> bool {
        match self {
    ...
    fn set(&self, settings: &mut PlasterWallMaterialSettings, value: bool) {
        match self {
